...
public class JungleTemple extends ScatteredStructurePiece {
    ...
    public void generate(ChunkManager level, NukkitRandom random) {
        ...
        StructureBuilder builder = new StructureBuilder(level, this);
        ...
        builder.fill(new BlockVector3(2, 1, 8), new BlockVector3(3, 1, 8), Block.TRIPWIRE);
        ...
        builder.fill(new BlockVector3(7, 1, 2), new BlockVector3(7, 1, 4), Block.TRIPWIRE);
        ...
        // 2nd floor inside
        for (int i = 0; i < 4; i++) {
            builder.fill(new BlockVector3(5, 4 - i, 6 + i), new BlockVector3(6, 4 - i, 6 + i), Block.COBBLESTONE_STAIRS, 3); // S
        }
        ...
        for (int i = 0; i < 3; i++) {
            builder.setBlock(new BlockVector3(7, 5 + i, 8 + i), Block.COBBLESTONE_STAIRS, 2); // N
            builder.setBlock(new BlockVector3(4, 5 + i, 8 + i), Block.COBBLESTONE_STAIRS, 2); // N
        }

        // 3rd floor inside
        builder.fillWithRandomBlock(new BlockVector3(5, 8, 5), new BlockVector3(6, 8, 5), random, stones);
        builder.setBlock(new BlockVector3(7, 8, 5), Block.COBBLESTONE_STAIRS, 1); // E
        builder.setBlock(new BlockVector3(4, 8, 5), Block.COBBLESTONE_STAIRS, 0); // W
